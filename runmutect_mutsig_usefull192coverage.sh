...
if [[ $data == "henan" ]]
then
  outputpreface=mutect3_henan
  mutsigoutputfolder=/fh/scratch/delete30/dai_j/henan/mutsig
  wgstumors=(3A 11A 13A 15A 17A 25A 29A 33A 37A 41A)
  mutectfolder=/fh/scratch/delete30/dai_j/henan/mutect3
fi
if [[ $data == "dulak" ]]
then
  outputpreface=mutect1_dulak
  ...
  mutectfolder=/fh/scratch/delete30/dai_j/mutect1
fi
if [[ $data == "escc" ]]
then
  ...
  mutectfolder=/fh/scratch/delete30/dai_j/escc/mutect2
fi
cd $mutectfolder
